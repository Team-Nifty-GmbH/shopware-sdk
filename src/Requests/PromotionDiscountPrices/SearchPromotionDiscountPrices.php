...
/**
 * searchPromotionDiscountPrices
 *
 * Available since: 6.0.0.0
 */
class SearchPromotionDiscountPrices extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/promotion-discount-prices';
    }
    ...
    {
        return array_map(
            fn (array $item) => PromotionDiscountPrices::from($item),
            $response->json('data') ?? []
        );
    }
}
