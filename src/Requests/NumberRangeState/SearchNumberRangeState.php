...
/**
 * searchNumberRangeState
 *
 * Available since: 6.0.0.0
 */
class SearchNumberRangeState extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/number-range-state";
	}
    ...
    {
        return array_map(
            fn (array $item) => NumberRangeState::from($item),
            $response->json('data') ?? []
        );
    }
}
