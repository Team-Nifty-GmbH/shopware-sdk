...
/**
 * searchSalesChannelDomain
 *
 * Available since: 6.0.0.0
 */
class SearchSalesChannelDomain extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/sales-channel-domain";
	}
    ...
    {
        return array_map(
            fn (array $item) => SalesChannelDomain::from($item),
            $response->json('data') ?? []
        );
    }
}
