...
/**
 * searchMailHeaderFooter
 *
 * Available since: 6.0.0.0
 */
class SearchMailHeaderFooter extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/mail-header-footer";
	}
    ...
    {
        return array_map(
            fn (array $item) => MailHeaderFooter::from($item),
            $response->json('data') ?? []
        );
    }
}
