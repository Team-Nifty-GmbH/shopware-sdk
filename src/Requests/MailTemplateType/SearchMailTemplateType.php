...
/**
 * searchMailTemplateType
 *
 * Available since: 6.0.0.0
 */
class SearchMailTemplateType extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/mail-template-type';
    }
    ...
    {
        return array_map(
            fn (array $item) => MailTemplateType::from($item),
            $response->json('data') ?? []
        );
    }
}
