 ...
 */
class SearchPromotionIndividualCode extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/promotion-individual-code";
	}
    ...
    {
        return array_map(
            fn (array $item) => PromotionIndividualCode::from($item),
            $response->json('data') ?? []
        );
    }
}
