...
/**
 * searchNumberRangeSalesChannel
 *
 * Available since: 6.0.0.0
 */
class SearchNumberRangeSalesChannel extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/number-range-sales-channel";
	}
    ...
    {
        return array_map(
            fn (array $item) => NumberRangeSalesChannel::from($item),
            $response->json('data') ?? []
        );
    }
}
