 ...
 */
class SearchSalesChannelAnalytics extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/sales-channel-analytics';
    }
    ...
    {
        return array_map(
            fn (array $item) => SalesChannelAnalytics::from($item),
            $response->json('data') ?? []
        );
    }
}
