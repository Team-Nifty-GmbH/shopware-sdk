...
/**
 * searchPromotionDiscount
 *
 * Available since: 6.0.0.0
 */
class SearchPromotionDiscount extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/promotion-discount";
	}
    ...
    {
        return array_map(
            fn (array $item) => PromotionDiscount::from($item),
            $response->json('data') ?? []
        );
    }
}
