...
/**
 * searchProductSearchKeyword
 *
 * Available since: 6.0.0.0
 */
class SearchProductSearchKeyword extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/product-search-keyword';
    }
    ...
    {
        return array_map(
            fn (array $item) => ProductSearchKeyword::from($item),
            $response->json('data') ?? []
        );
    }
}
