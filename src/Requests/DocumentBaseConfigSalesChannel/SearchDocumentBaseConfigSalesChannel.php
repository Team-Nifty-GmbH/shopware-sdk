...
/**
 * searchDocumentBaseConfigSalesChannel
 *
 * Available since: 6.0.0.0
 */
class SearchDocumentBaseConfigSalesChannel extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/document-base-config-sales-channel";
	}
    ...
    {
        return array_map(
            fn (array $item) => DocumentBaseConfigSalesChannel::from($item),
            $response->json('data') ?? []
        );
    }
}
