...
/**
 * searchProductCrossSelling
 *
 * Available since: 6.1.0.0
 */
class SearchProductCrossSelling extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/product-cross-selling';
    }
    ...
    {
        return array_map(
            fn (array $item) => ProductCrossSelling::from($item),
            $response->json('data') ?? []
        );
    }
}
