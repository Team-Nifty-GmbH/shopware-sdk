...
/**
 * searchAppPaymentMethod
 *
 * Available since: 6.4.1.0
 */
class SearchAppPaymentMethod extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/app-payment-method';
    }
    ...
    {
        return array_map(
            fn (array $item) => AppPaymentMethod::from($item),
            $response->json('data') ?? []
        );
    }
}
