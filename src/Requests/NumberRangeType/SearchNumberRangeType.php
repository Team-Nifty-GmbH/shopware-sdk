...
/**
 * searchNumberRangeType
 *
 * Available since: 6.0.0.0
 */
class SearchNumberRangeType extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/number-range-type';
    }
    ...
    {
        return array_map(
            fn (array $item) => NumberRangeType::from($item),
            $response->json('data') ?? []
        );
    }
}
