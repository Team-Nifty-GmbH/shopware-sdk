 ...
 */
class SearchOrderTransactionCaptureRefund extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/order-transaction-capture-refund';
    }
    ...
    {
        return array_map(
            fn (array $item) => OrderTransactionCaptureRefund::from($item),
            $response->json('data') ?? []
        );
    }
}
