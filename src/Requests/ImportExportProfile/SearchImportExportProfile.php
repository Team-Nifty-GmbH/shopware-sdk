...
/**
 * searchImportExportProfile
 *
 * Available since: 6.0.0.0
 */
class SearchImportExportProfile extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/import-export-profile";
	}
    ...
    {
        return array_map(
            fn (array $item) => ImportExportProfile::from($item),
            $response->json('data') ?? []
        );
    }
}
