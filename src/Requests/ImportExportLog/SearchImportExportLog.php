...
/**
 * searchImportExportLog
 *
 * Available since: 6.0.0.0
 */
class SearchImportExportLog extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/import-export-log";
	}
    ...
    {
        return array_map(
            fn (array $item) => ImportExportLog::from($item),
            $response->json('data') ?? []
        );
    }
}
