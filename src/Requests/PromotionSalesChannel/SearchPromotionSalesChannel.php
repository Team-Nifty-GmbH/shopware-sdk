...
/**
 * searchPromotionSalesChannel
 *
 * Available since: 6.0.0.0
 */
class SearchPromotionSalesChannel extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/promotion-sales-channel";
	}
    ...
    {
        return array_map(
            fn (array $item) => PromotionSalesChannel::from($item),
            $response->json('data') ?? []
        );
    }
}
