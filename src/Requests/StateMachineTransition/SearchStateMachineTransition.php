...
/**
 * searchStateMachineTransition
 *
 * Available since: 6.0.0.0
 */
class SearchStateMachineTransition extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/state-machine-transition';
    }
    ...
    {
        return array_map(
            fn (array $item) => StateMachineTransition::from($item),
            $response->json('data') ?? []
        );
    }
}
