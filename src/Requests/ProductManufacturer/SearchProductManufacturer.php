...
/**
 * searchProductManufacturer
 *
 * Available since: 6.0.0.0
 */
class SearchProductManufacturer extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/product-manufacturer";
	}
    ...
    {
        return array_map(
            fn (array $item) => ProductManufacturer::from($item),
            $response->json('data') ?? []
        );
    }
}
