...
/**
 * searchMediaThumbnailSize
 *
 * Available since: 6.0.0.0
 */
class SearchMediaThumbnailSize extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/media-thumbnail-size';
    }
    ...
    {
        return array_map(
            fn (array $item) => MediaThumbnailSize::from($item),
            $response->json('data') ?? []
        );
    }
}
