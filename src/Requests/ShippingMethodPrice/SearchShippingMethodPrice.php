...
/**
 * searchShippingMethodPrice
 *
 * Available since: 6.0.0.0
 */
class SearchShippingMethodPrice extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/shipping-method-price';
    }
    ...
    {
        return array_map(
            fn (array $item) => ShippingMethodPrice::from($item),
            $response->json('data') ?? []
        );
    }
}
