 ...
 */
class SearchProductConfiguratorSetting extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/product-configurator-setting';
    }
    ...
    {
        return array_map(
            fn (array $item) => ProductConfiguratorSetting::from($item),
            $response->json('data') ?? []
        );
    }
}
