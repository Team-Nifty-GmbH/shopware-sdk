...
/**
 * searchProductKeywordDictionary
 *
 * Available since: 6.0.0.0
 */
class SearchProductKeywordDictionary extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/product-keyword-dictionary";
	}
    ...
    {
        return array_map(
            fn (array $item) => ProductKeywordDictionary::from($item),
            $response->json('data') ?? []
        );
    }
}
