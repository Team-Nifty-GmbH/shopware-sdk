...
/**
 * searchOrderTransaction
 *
 * Available since: 6.0.0.0
 */
class SearchOrderTransaction extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/order-transaction";
	}
    ...
    {
        return array_map(
            fn (array $item) => OrderTransaction::from($item),
            $response->json('data') ?? []
        );
    }
}
