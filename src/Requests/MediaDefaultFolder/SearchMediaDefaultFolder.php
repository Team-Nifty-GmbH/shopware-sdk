...
/**
 * searchMediaDefaultFolder
 *
 * Available since: 6.0.0.0
 */
class SearchMediaDefaultFolder extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/media-default-folder";
	}
    ...
    {
        return array_map(
            fn (array $item) => MediaDefaultFolder::from($item),
            $response->json('data') ?? []
        );
    }
}
