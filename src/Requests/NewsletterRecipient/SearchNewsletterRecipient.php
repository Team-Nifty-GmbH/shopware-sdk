...
/**
 * searchNewsletterRecipient
 *
 * Available since: 6.0.0.0
 */
class SearchNewsletterRecipient extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return '/search/newsletter-recipient';
    }
    ...
    {
        return array_map(
            fn (array $item) => NewsletterRecipient::from($item),
            $response->json('data') ?? []
        );
    }
}
