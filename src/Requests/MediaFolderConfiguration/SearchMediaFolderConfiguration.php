...
/**
 * searchMediaFolderConfiguration
 *
 * Available since: 6.0.0.0
 */
class SearchMediaFolderConfiguration extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/media-folder-configuration";
	}
    ...
    {
        return array_map(
            fn (array $item) => MediaFolderConfiguration::from($item),
            $response->json('data') ?? []
        );
    }
}
