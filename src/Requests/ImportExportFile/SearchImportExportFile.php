...
/**
 * searchImportExportFile
 *
 * Available since: 6.0.0.0
 */
class SearchImportExportFile extends Request implements HasBody
{
	use HasJsonBody;
	...
	{
		return "/search/import-export-file";
	}
    ...
    {
        return array_map(
            fn (array $item) => ImportExportFile::from($item),
            $response->json('data') ?? []
        );
    }
}
